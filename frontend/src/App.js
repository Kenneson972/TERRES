...
const GaleriePage = () => {
  ...
  return (<div className="page-container"><Navigation /><section className="galerie-section luxury" style={{ minHeight: '100vh', paddingTop: 'var(--spacing-2xl)' }}><div className="container"><div className="section-header-luxury"><span className="luxury-subtitle">Découvrez</span><h2 className="section-title-luxury">Notre Villa d'Exception</h2><p className="section-description-luxury">Faites défiler horizontalement pour explorer notre galerie en 3D</p></div><div style={{ height: '600px', position: 'relative', marginTop: 'var(--spacing-2xl)' }}><CircularGallery items={gallery} bend={2.5} textColor="#F59E0B" borderRadius={0.08} scrollEase={0.08} scrollSpeed={1.5} font="bold 24px Inter" /></div></div></section><section className="features-section luxury"><div className="container"><h2 className="section-title-luxury">Caractéristiques Premium</h2><div className="features-grid-luxury"><div className="feature-card-luxury"><div className="feature-icon-luxury"><Users size={40} /></div><h3>Capacité 80 personnes</h3><p>Idéal pour vos événements privés et célébrations mémorables</p></div><div className="feature-card-luxury"><div className="feature-icon-luxury"><Home size={40} /></div><h3>Villa spacieuse</h3><p>Espaces intérieurs et extérieurs généreux pour votre confort</p></div><div className="feature-card-luxury"><div className="feature-icon-luxury"><Home size={40} /></div><h3>Piscine privée</h3><p>Profitez d'une piscine exclusive avec vue panoramique</p></div><div className="feature-card-luxury"><div className="feature-icon-luxury"><CheckCircle size={40} /></div><h3>Équipements haut de gamme</h3><p>Cuisine professionnelle, sonorisation, climatisation</p></div><div className="feature-card-luxury"><div className="feature-icon-luxury"><CheckCircle size={40} /></div><h3>Espaces modulables</h3><p>Configuration personnalisée selon vos besoins</p></div><div className="feature-card-luxury"><div className="feature-icon-luxury"><CheckCircle size={40} /></div><h3>Parking sécurisé</h3><p>Stationnement privé pour vos invités</p></div></div></div></section><Footer /><Toaster position="top-right" /></div>);
};
